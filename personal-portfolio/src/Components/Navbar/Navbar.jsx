...
const Navbar = () => {
  ...
  return (
    <header className="text-zinc-600 body-font z-10">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <a className="flex title-font font-medium items-center text-zinc-900 mb-4 md:mb-0">
...
mt-4 md:mt-0 border-white hover:border-yellow-300 hover:text-zinc-900">
