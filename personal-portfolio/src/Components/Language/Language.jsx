...
const Language = () => {
  const languages = [
    ...
    { code: "Ur", name: "Urdu", level: "Good" },
  ];
  return (
    <section
      data-aos="fade-up"
      data-aos-delay="400"
      className="flex flex-wrap md:flex-nowrap items-center justify-center gap-10 md:gap-20 h-[300] text-blue-950 mt-11">
        ...
        {languages.map((language, index) => (
          <div key={index} className="achievement flex flex-col items-center">
            <div className="circle w-20 h-20 md:w-16 md:h-16 bg-white rounded-full relative flex items-center justify-center text-lg md:text-xl font-bold mb-6 md:mb-8 shadow-lg">
              ...
              <div className="absolute top-[-6px] left-[-6px] right-[-6px] botom-[-6px] md:top-[-8px] md:left-[-8px] md:right-[-8px] md:bottom-[-8px] rounded-full bg-gradient-to-b from-[#ff9743] to-[#ffe460] shadow-[0_0_20px_rgba(255,165,0,0.7)] z-0"></div>
            </div>
