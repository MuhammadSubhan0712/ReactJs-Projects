...
const Cart = () => {
  ...
  return (
    <div className="min-h-screen my-15 bg-gradient-to-b from-blue-100 to-blue-200 py-12 px-4 sm:px-6 lg:px-8">
        ...
        {cartItems.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 h-fit sticky top-8">
              ...
              <button className="mt-6 w-full bg-green-600 hover:bg-green-700 text-white py-3 px-4 rounded-lg font-medium transition-colors duration-300 shadow-md hover:shadow-lg">
                Proceed to Checkout
              </button>
