...
import { Send, Mail, User, MessageSquare, Facebook, Instagram, Linkedin, Github } from 'lucide-react';
...
const Contact = () => {
  ...
  return (
    <>
   <section id='contact' className='relative bg-gradient-to-b from-gray-900 to-gray-950 py-20 px-4 overflow-hidden'>
      {/* Floating background */}
      ...
      <div className='max-w-7xl mx-auto relative z-10'>
        ...
        <div className='text-center mb-16'>
          <div className="inline-flex items-center gap-4 px-6 py-3 bg-cyan-400/10 rounded-full border border-cyan-400/30 mb-6 mx-auto">
            ...
            <span className="text-sm font-bold tracking-widest text-cyan-400 uppercase">Contact</span>
          </div>
        ...
        <div className='flex flex-col lg:flex-row justify-between items-center gap-12'>
          ...
          <div className='w-full lg:w-1/2 relative group'>
            ...
            <div className='relative bg-gray-900/80 backdrop-blur-sm rounded-xl p-8 border border-cyan-400/20 h-full'>
              ...
              <p className='text-gray-300 mb-8 leading-relaxed'>
                ...
                <span className="block mt-2 text-cyan-400">Let's build something amazing together!</span>
              </p>
              
              {/* Social links: */}
              <div className="flex gap-6 mb-8">
                {[
                  { icon: <Facebook className="w-5 h-5" />, color: "bg-blue-500/20", hover: "hover:bg-blue-500/40" },
                  { icon: <Instagram className="w-5 h-5" />, color: "bg-pink-500/20", hover: "hover:bg-pink-500/40" },
                  { icon: <Linkedin className="w-5 h-5" />, color: "bg-blue-400/20", hover: "hover:bg-blue-400/40" },
                  { icon: <Github className="w-5 h-5" />, color: "bg-gray-500/20", hover: "hover:bg-gray-500/40" }
                ].map((social, index) => (
                  <a 
                    key={index}
                    href="#" 
          ...
          <div className='w-full lg:w-1/2 relative group'>
            ...
            <form className='relative bg-gray-900/80 backdrop-blur-sm rounded-xl p-8 border border-red-400/20'>
