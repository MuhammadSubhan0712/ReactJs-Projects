...
return (
<>
<section id='projects' className='relative bg-gradient-to-b from-gray-900 to-gray-950 py-20 px-4 overflow-hidden'>
      ...
      <div className='max-w-7xl mx-auto relative z-10'>
        ...
        <div className='mb-16 text-center md:text-left'>
          <div className="inline-flex items-center gap-4 px-6 py-3 bg-cyan-400/10 rounded-full border border-cyan-400/30 mb-6">
            ...
            <span className="text-sm font-bold tracking-widest text-cyan-400 uppercase">Projects</span>
          </div>
